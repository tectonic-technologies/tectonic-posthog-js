!(function (e) {
    ...
    function I(e) {
        try {
            ...
            return t
                ? ((n = Array.from(t).map(C).join('')).includes(' background-clip: text;') &&
    ...
    var b = (function () {
        function e() {
            s(this, e), (this.idNodeMap = new Map()), (this.nodeMetaMap = new WeakMap())
        }
        return (
            c(e, [
                {
    ...
    function S(e) {
        var t = e.element,
            ...
            s = a || '',
            u = o && w(o)
        return (n[r.toLowerCase()] || (u && n[u])) && (s = i ? i(s, t) : '*'.repeat(s.length)), s
    }
    function w(e) {
    ...
    function k(e) {
        var t = e.type
        return e.hasAttribute('data-rr-is-password') ? 'password' : t ? w(t) : null
    }
    function M(e, t) {
        var n, r
        try {
    ...
    function W(e, t) {
        return (e || '').replace(L, function (e, n, r, o, a, i) {
            var s,
                ...
                c = n || o || ''
            if (!u) return e
            if (F.test(u) || D.test(u)) return 'url('.concat(c).concat(u).concat(c, ')')
                ...
                ? 'srcset' === n
                    ? (function (e, t) {
                          ...
                          for (var o = []; r(V), !(n >= t.length); ) {
                              var a = r(G)
                              if (',' === a.slice(-1)) (a = Z(e, a.substring(0, a.length - 1))), o.push(a)
                              else {
                                  var i = ''
                                  a = Z(e, a)
                                  for (var s = !1; ; ) {
    ...
    function H(e, t, n) {
        if (!e) return !1
        if (e.nodeType !== e.ELEMENT_NODE) return !!n && H(e.parentNode, t, n)
        for (var r = e.classList.length; r--; ) {
            var o = e.classList[r]
            if (t.test(o)) return !0
        }
        return !!n && H(e.parentNode, t, n)
    }
    function P(e, t, n, r) {
        try {
    ...
    function Y(e, t) {
        ...
        switch (e.nodeType) {
            ...
            case e.DOCUMENT_TYPE_NODE:
                return { type: m.DocumentType, name: e.name, publicId: e.publicId, systemId: e.systemId, rootId: b }
            case e.ELEMENT_NODE:
                return (function (e, t) {
                    for (
                        var n,
                        ...
                        _(b, x.name, x.value) || (M[x.name] = j(r, b, w(x.name), x.value))
                    }
                    if ('link' === b && i) {
                        var L = e.href,
                            F = Array.from(r.styleSheets).find(function (e) {
                                return e.href === L
                            })
                        if (!F && L.includes('.css')) {
                            var D = window.location.origin + '/' + L.replace(window.location.href, '')
                            F = Array.from(r.styleSheets).find(function (e) {
                                return e.href === D
                            })
                        }
                        var B = null
                        F && (B = I(F)), B && (delete M.rel, delete M.href, (M._cssText = W(B, F.href)))
                    }
                    ...
                    if ('input' === b || 'textarea' === b || 'select' === b) {
                        var V = e.value,
                            Z = e.checked
                        'radio' !== M.type && 'checkbox' !== M.type && 'submit' !== M.type && 'button' !== M.type && V
                            ? (M.value = S({
                                  element: e,
                                  type: k(e),
                                  tagName: b,
                    ...
                    'option' === b && (e.selected && !u.select ? (M.selected = !0) : delete M.selected)
                    if ('canvas' === b && p)
                        if ('2d' === e.__context)
                            (function (e) {
                            ...
                            ;(P.width = e.width),
                                (P.height = e.height),
                                H !== P.toDataURL(d.type, d.quality) && (M.rr_dataURL = H)
                        }
                    if ('img' === b && f) {
                        T || ((T = r.createElement('canvas')), (N = T.getContext('2d')))
                        var Y = e,
                            q = Y.crossOrigin
                        ...
                        var J = function e() {
                            ...
                            try {
                                ;(T.width = Y.naturalWidth),
                                    (T.height = Y.naturalHeight),
                                    N.drawImage(Y, 0, 0),
                                    (M.rr_dataURL = T.toDataURL(d.type, d.quality))
                            } catch (e) {
                                console.warn('Cannot inline img src='.concat(Y.currentSrc, '! Error: ').concat(e))
                            }
                            q ? (M.crossOrigin = q) : Y.removeAttribute('crossorigin')
                        }
                        Y.complete && 0 !== Y.naturalWidth ? J() : Y.addEventListener('load', J)
                    }
                    if ('audio' === b || 'video' === b) {
                        var z = M
                        ;(z.rr_mediaState = e.paused ? 'paused' : 'played'),
                            (z.rr_mediaCurrentTime = e.currentTime),
                            (z.rr_mediaPlaybackRate = e.playbackRate),
                            (z.rr_mediaMuted = e.muted),
                            (z.rr_mediaLoop = e.loop),
                            (z.rr_mediaVolume = e.volume)
                    }
                    v ||
                    ...
                    if (C) {
                        var Q = e.getBoundingClientRect(),
                            X = Q.width,
                            $ = Q.height
                        M = { class: M.class, rr_width: ''.concat(X, 'px'), rr_height: ''.concat($, 'px') }
                    }
                    'iframe' !== b || h(M.src) || (e.contentDocument || (M.rr_src = M.src), delete M.src)
                    try {
            ...
            case e.TEXT_NODE:
                return (function (e, t) {
                    ...
                    !u && !c && s && r && (s = o ? o(s, e.parentElement) : s.replace(/[\S]/g, '*'))
    ...
    function J(e, t) {
        var n = t.doc,
            ...
            K = void 0 === U || U
        !Z && e.childNodes && (Z = P(e, i, s, void 0 === Z))
        var j,
            _ = Y(e, {
                doc: n,
                mirror: r,
            ...
            : !(function (e, t) {
                  ...
                  if (e.type === m.Element) {
                      ...
                      if (
                          ...
                          return !0
                      if ('meta' === e.tagName) {
                          if (t.headMetaDescKeywords && q(e.attributes.name).match(/^description|keywords$/)) return !0
                          if (
                              t.headMetaSocial &&
              ...
              (K || _.type !== m.Text || _.isStyle || _.textContent.replace(/^\s+|\s+$/gm, '').length)
            ? x()
            : R
        var H = Object.assign(_, { id: j })
        if ((r.add(e, H), j === R)) return null
        T && T(e)
        var z = !c
        if (H.type === m.Element) {
            ;(z = z && !H.needBlock), delete H.needBlock
            var Q = e.shadowRoot
            Q && y(Q) && (H.isShadowHost = !0)
        }
        if ((H.type === m.Document || H.type === m.Element) && z) {
            I.headWhitespace && H.type === m.Element && 'head' === H.tagName && (K = !1)
            var X = {
                doc: n,
                mirror: r,
                blockClass: o,
            ...
            if (H.type === m.Element && 'textarea' === H.tagName && void 0 !== H.attributes.value);
            else
                for (var $ = 0, ee = Array.from(e.childNodes); $ < ee.length; $++) {
                    var te = J(ee[$], X)
                    te && H.childNodes.push(te)
                }
            if (
                (function (e) {
                ...
                for (var ne = 0, re = Array.from(e.shadowRoot.childNodes); ne < re.length; ne++) {
                    var oe = J(re[ne], X)
                    oe && (y(e.shadowRoot) && (oe.isShadow = !0), H.childNodes.push(oe))
                }
        }
        return (
            e.parentNode && v(e.parentNode) && y(e.parentNode) && (H.isShadow = !0),
            H.type === m.Element &&
                'iframe' === H.tagName &&
                (function (e, t, n) {
    ...
    function ce(e, t) {
        ...
        return (
            !t.has(n) ||
            ((!e.parentNode || e.parentNode.nodeType !== e.DOCUMENT_NODE) && (!e.parentNode || ce(e.parentNode, t)))
        )
    }
    function le(e) {
    ...
    var he = (function () {
        function e() {
            s(this, e), (this.id = 1), (this.styleIDMap = new WeakMap()), (this.idStyleMap = new Map())
        }
        return (
            c(e, [
                {
                ...
                c(e, [
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            if (((e.__ln = t), e.previousSibling && we(e.previousSibling))) {
                                var n = e.previousSibling.__ln.next
                                ;(t.next = n),
                                    (t.previous = e.previousSibling.__ln),
                                    (e.previousSibling.__ln.next = t),
                                    n && (n.previous = t)
                            } else if (e.nextSibling && we(e.nextSibling) && e.nextSibling.__ln.previous) {
                        ...
                        if (!t.frozen && !t.locked) {
                            for (
                                var e = [],
                                    ...
                                    a = function (a) {
                                        if (a.parentNode && ve(a) && 'TEXTAREA' !== a.parentNode.tagName) {
                                            ...
                                            var u = J(a, {
                                                ...
                                                onSerialize: function (e) {
                                                    de(e, t.mirror) && t.iframeManager.addIframe(e),
                                                        ...
                                                        pe(a) && t.shadowDomManager.addShadowRoot(a.shadowRoot, t.doc)
                                                },
                                            ...
                                            u && (e.push({ parentId: i, nextId: s, node: u }), n.add(u.id))
                                        }
                                    };
                                t.mapRemoves.length;
                            ...
                            try {
                                for (s.s(); !(i = s.n()).done; ) {
                                    var u = i.value
                                    ;(Oe(t.removes, u, t.mirror) && !t.movedSet.has(u.parentNode)) || a(u)
                                }
                            } catch (e) {
                                s.e(e)
                            } finally {
                            ...
                            try {
                                for (l.s(); !(c = l.n()).done; ) {
                                    var d = c.value
                                    Re(t.droppedSet, d) || Oe(t.removes, d, t.mirror)
                                        ? Re(t.movedSet, d)
                                            ? a(d)
                                            : t.droppedSet.add(d)
                                        : a(d)
                            ...
                            switch (e.type) {
                                case 'characterData':
                                    ...
                                    se(e.target, t.blockClass, t.blockSelector, !1) ||
                                        ...
                                        t.texts.push({
                                            value:
                                                P(e.target, t.maskTextClass, t.maskTextSelector, !0) && n
                                                    ? t.maskTextFn
                                ...
                                case 'attributes':
                                    ...
                                    if (se(e.target, t.blockClass, t.blockSelector, !1) || a === e.oldValue) return
                                    var s = t.attributeMap.get(e.target)
                                    if ('IFRAME' === r.tagName && 'src' === o && !t.keepIframeSrcFn(a)) {
                                    ...
                                    if (
                                        ...
                                        !_(r.tagName, o) &&
                                            ((s.attributes[o] = j(t.doc, w(r.tagName), w(o), a)), 'style' === o))
                                    ) {
                                        if (!t.unattachedDoc)
                                            try {
                                        ...
                                        for (var c = 0, l = Array.from(r.style); c < l.length; c++) {
                                            var d = l[c],
                                        ...
                                        for (var h = 0, g = Array.from(u.style); h < g.length; h++) {
                                            var m = g[h]
                                            '' === r.style.getPropertyValue(m) && (s.styleDiff[m] = !1)
                                        }
                                    }
                                    break
                                case 'childList':
                                    ...
                                    e.addedNodes.forEach(function (n) {
                                        ...
                                        e.removedNodes.forEach(function (n) {
                                            ...
                                            se(e.target, t.blockClass, t.blockSelector, !1) ||
                                                ...
                                                (t.addedSet.has(n)
                                                    ? (Ne(t.addedSet, n), t.droppedSet.add(n))
                                                    : (t.addedSet.has(e.target) && -1 === r) ||
                                                      ...
                                                      (t.movedSet.has(n) && t.movedMap[Me(r, o)]
                                                          ...
                                                          : t.removes.push({
                                                                parentId: o,
                                                                id: r,
                                                                isShadow: !(!v(e.target) || !y(e.target)) || void 0,
                                                            })),
                                                t.mapRemoves.push(n))
                                        })
                            }
    ...
    function He(e, t) {
        ...
        return null !== s && -1 !== s && u && c
            ? (Object.defineProperty(t, 'adoptedStyleSheets', {
                  ...
                  set: function (e) {
                      var t,
                          n = null === (t = c.set) || void 0 === t ? void 0 : t.call(this, e)
                      if (null !== s && -1 !== s)
                          try {
    ...
    function Pe(e) {
        ...
        var o = (function (e) {
            ...
            u = (function (e) {
                ...
                function p(e) {
                    ...
                    if (
                        ...
                        'radio' === g &&
                            m &&
                            p &&
                            n.querySelectorAll('input[type="radio"][name="'.concat(m, '"]')).forEach(function (e) {
                                if (e !== t) {
                                    var n = e.value
                ...
                var g = ('last' === l.input ? ['change'] : ['input', 'change']).map(function (e) {
                        return z(e, De(p), n)
                    }),
                    m = n.defaultView
                if (!m)
                ...
                var v = m.Object.getOwnPropertyDescriptor(m.HTMLInputElement.prototype, 'value'),
                    y = [
        ...
        e.recordDOM &&
            ((l = (function (e, t) {
                ...
                ;(a.CSSStyleSheet.prototype.deleteRule = new Proxy(c, {
                    apply: De(function (e, t, a) {
                        var i = d(a, 1)[0],
                            s = _e(t, r, o.styleMirror),
                            u = s.id,
                            c = s.styleId
                        return (
                            ((u && -1 !== u) || (c && -1 !== c)) && n({ id: u, styleId: c, removes: [{ index: i }] }),
                            e.apply(t, a)
                        )
                    }),
                })),
                        ...
                        (a.CSSStyleSheet.prototype.replace = new Proxy(s, {
                            apply: De(function (e, t, a) {
                                var i = d(a, 1)[0],
                                    ...
                                    c = s.styleId
                                return (
                                    ((u && -1 !== u) || (c && -1 !== c)) && n({ id: u, styleId: c, replace: i }),
                                    e.apply(t, a)
                                )
                            }),
                        }))),
                        ...
                        (a.CSSStyleSheet.prototype.replaceSync = new Proxy(u, {
                            apply: De(function (e, t, a) {
                                var i = d(a, 1)[0],
                                    ...
                                    c = s.styleId
                                return (
                                    ((u && -1 !== u) || (c && -1 !== c)) && n({ id: u, styleId: c, replaceSync: i }),
                                    e.apply(t, a)
                                )
                            }),
                        })))
                ...
                return (
                    Object.entries(l).forEach(function (e) {
                        var t = d(e, 2),
                            a = t[0],
                            i = t[1]
                        ;(p[a] = { insertRule: i.prototype.insertRule, deleteRule: i.prototype.deleteRule }),
                            (i.prototype.insertRule = new Proxy(p[a].insertRule, {
                                apply: De(function (e, t, a) {
                                    var i = d(a, 2),
                                        s = i[0],
                                        u = i[1],
                                        c = _e(t.parentStyleSheet, r, o.styleMirror),
                                        l = c.id,
                                        p = c.styleId
                                    return (
                                        ((l && -1 !== l) || (p && -1 !== p)) &&
                                            n({
                                                id: l,
                                                styleId: p,
                                                adds: [{ rule: s, index: [].concat(f(je(t)), [u || 0]) }],
                                            }),
                                        e.apply(t, a)
                                    )
                                }),
                            ...
                            (i.prototype.deleteRule = new Proxy(p[a].deleteRule, {
                                apply: De(function (e, t, a) {
                                    var i = d(a, 1)[0],
                                        s = _e(t.parentStyleSheet, r, o.styleMirror),
                                        u = s.id,
                                        c = s.styleId
                                    return (
                                        ((u && -1 !== u) || (c && -1 !== c)) &&
                                            n({ id: u, styleId: c, removes: [{ index: [].concat(f(je(t)), [i]) }] }),
                                        e.apply(t, a)
                                    )
                                }),
                            }))
                ...
                return (
                    (i.CSSStyleDeclaration.prototype.removeProperty = new Proxy(u, {
                        apply: De(function (e, t, i) {
                            ...
                            return (
                                ((f && -1 !== f) || (p && -1 !== p)) &&
                                    n({ id: f, styleId: p, remove: { property: c }, index: je(t.parentRule) }),
                                e.apply(t, i)
                            )
                        }),
                    })),
        ...
        try {
            for (b.s(); !(v = b.n()).done; ) {
                var w = v.value
                C.push(w.observer(w.callback, r, w.options))
            }
        } catch (e) {
            b.e(e)
        } finally {
                        ...
                        value: function (e, t) {
                            ...
                            this.restoreHandlers.push(
                                te(e.prototype, 'attachShadow', function (e) {
                                    return function (r) {
                                        var o = e.call(this, r)
                                        return this.shadowRoot && ve(this) && n.addShadowRoot(this.shadowRoot, t), o
                                    }
                                })
                            )
                        },
    ...
    function ot(e, t, n) {
        ...
        if (e instanceof DataView)
            return { rr_type: e.constructor.name, args: [ot(e.buffer, t, n), e.byteOffset, e.byteLength] }
        ...
        return e instanceof ImageData
            ? { rr_type: e.constructor.name, args: [ot(e.data, t, n), e.width, e.height] }
            : it(e, t) || 'object' === o(e)
            ...
            var i = te(e.HTMLCanvasElement.prototype, 'getContext', function (e) {
                return function (a) {
                    ...
                    if (!se(this, t, n, !0)) {
                        ...
                        if (('__context' in this || (this.__context = c), r && ['webgl', 'webgl2'].includes(c)))
                            if (s[0] && 'object' === o(s[0])) {
                                var l = s[0]
                ...
                try {
                    ...
                    var c = te(e, a, function (e) {
                        return function () {
                            ...
                            if ((rt(l, i, this), 'tagName' in this.canvas && !se(this.canvas, r, o, !0))) {
                                var d = at(u, i, this),
        ...
        yt = (function () {
            function e(t) {
                ...
                ;(this.mutationCb = t.mutationCb),
                    ...
                    c && 'number' == typeof o && this.initCanvasFPSObserver(o, a, i, u, { dataURLOptions: l })
            }
            return (
                c(e, [
                    {
                                                      ...
                                                      function (t) {
                                                          for (;;)
                                                              switch ((t.prev = t.next)) {
                                                                  case 0:
                                                                      if (((o = this.mirror.getId(e)), !u.get(o))) {
                                                                          t.next = 3
                                                                          break
                                                                      }
                        ...
                        value: function (e, t, n) {
                            ...
                            var r = st(e, t, n, !1),
                                o = (function (e, t, n, r) {
                                    var o,
                                        a = [],
                                        i = g(Object.getOwnPropertyNames(t.CanvasRenderingContext2D.prototype))
                                    try {
                                        var s = function () {
                                            var i = o.value
                                            try {
                                                if ('function' != typeof t.CanvasRenderingContext2D.prototype[i])
                                                    return 'continue'
                                                var s = te(t.CanvasRenderingContext2D.prototype, i, function (o) {
                                                    return function () {
                                                        for (
                                                            var a = this, s = arguments.length, u = new Array(s), c = 0;
                                                            c < s;
                                                            c++
                                                        )
                                                            u[c] = arguments[c]
                                ...
                                a = (function (e, t, n, r, o) {
                                    ...
                                    return (
                                        a.push.apply(
                                            a,
                                            f(ut(t.WebGLRenderingContext.prototype, Se.WebGL, e, n, r, 0, t))
                                        ),
                                        void 0 !== t.WebGL2RenderingContext &&
                                            a.push.apply(
                                                a,
                                                f(ut(t.WebGL2RenderingContext.prototype, Se.WebGL2, e, n, r, 0, t))
                                            ),
                                        function () {
                                            a.forEach(function (e) {
                                                return e()
  ...
  ***************************************************************************** */
                                    ...
                                    for (a.s(); !(n = a.n()).done; ) {
                                        ...
                                        this.styleMirror.has(i)
                                            ...
                                            : ((s = this.styleMirror.add(i)),
                                              o.push({
                                                  styleId: s,
                                                  rules: Array.from(i.rules || CSSRule, function (e, t) {
        ...
        Ct = (function () {
            function e() {
                s(this, e), (this.nodeMap = new WeakMap()), (this.loop = !0), this.periodicallyClear()
            }
            return (
                c(e, [
                    {
    ...
    function At() {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
            ...
            W = void 0 !== B && B,
            G = e.recordAfter,
            V = void 0 === G ? ('DOMContentLoaded' === e.recordAfter ? e.recordAfter : 'load') : G,
        ...
        void 0 !== R && void 0 === N.mousemove && (N.mousemove = R), wt.reset()
        var te,
            ne =
                !0 === I
                    ? {
        ...
        ht = function (e, o) {
            ...
            if (
                (!(null === (a = Be[0]) || void 0 === a ? void 0 : a.isFrozen()) ||
                    ...
                    (e.type === ye.IncrementalSnapshot && e.data.source === Ie.Mutation) ||
                    Be.forEach(function (e) {
                        return e.unfreeze()
                    }),
                $)
        ...
        var ce,
            le = function (e) {
                ht(bt({ type: ye.IncrementalSnapshot, data: Object.assign({ source: Ie.Mutation }, e) }))
            },
            he = function (e) {
                return ht(bt({ type: ye.IncrementalSnapshot, data: Object.assign({ source: Ie.Scroll }, e) }))
            },
            ge = function (e) {
                return ht(bt({ type: ye.IncrementalSnapshot, data: Object.assign({ source: Ie.CanvasMutation }, e) }))
            },
            me = new It({
                mutationCb: le,
                adoptedStyleSheetCb: function (e) {
                    return ht(
                        bt({ type: ye.IncrementalSnapshot, data: Object.assign({ source: Ie.AdoptedStyleSheet }, e) })
                    )
                },
            }),
            ve = new ze({
        ...
        gt = function () {
            var e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0]
            if (L) {
                ht(bt({ type: ye.Meta, data: { href: window.location.href, width: ae(), height: oe() } }), e),
                    me.reset(),
                    we.init(),
                    Be.forEach(function (e) {
                        return e.lock()
                ...
                var t = (function (e, t) {
                    ...
                    inlineImages: H,
                    onSerialize: function (e) {
                        de(e, wt) && ve.addIframe(e),
                            fe(e, wt) && me.trackLinkElement(e),
                            pe(e) && we.addShadowRoot(e.shadowRoot, document)
                    },
                    onIframeLoad: function (e, t) {
                        ve.attachIframe(e, t), we.observeAttachShadow(e)
                    },
                ...
                ht(bt({ type: ye.FullSnapshot, data: { node: t, initialOffset: re(window) } }), e),
                    Be.forEach(function (e) {
                        return e.unlock()
                    }),
                    document.adoptedStyleSheets &&
                        document.adoptedStyleSheets.length > 0 &&
                        me.adoptStyleSheets(document.adoptedStyleSheets, wt.getId(document))
            }
        }
        try {
            var Ae = [],
                    ...
                    return De(Pe)(
                        {
                            ...
                            mousemoveCb: function (e, t) {
                                return ht(bt({ type: ye.IncrementalSnapshot, data: { source: t, positions: e } }))
                            },
                            ...
                            inputCb: function (e) {
                                return ht(
                                    bt({ type: ye.IncrementalSnapshot, data: Object.assign({ source: Ie.Input }, e) })
                                )
                            },
                            ...
                            fontCb: function (e) {
                                return ht(
                                    bt({ type: ye.IncrementalSnapshot, data: Object.assign({ source: Ie.Font }, e) })
                                )
                            },
                                ...
                                (null ===
                                    ...
                                    : t.map(function (e) {
                                          return {
                                              ...
                                              callback: function (t) {
                                                  return ht(
                                                      bt({ type: ye.Plugin, data: { plugin: e.name, payload: t } })
                                                  )
                                              },
                                          }
                                      })) || [],
            ...
            ve.addLoadListener(function (e) {
                try {
                    Ae.push(ke(e.contentDocument))
                } catch (e) {
                    console.warn(e)
                }
            })
            var Me = function () {
                gt(), Ae.push(ke(document)), (St = !0)
            }
            return (
                'interactive' === document.readyState || 'complete' === document.readyState
                    ...
                    : (Ae.push(
                          z('DOMContentLoaded', function () {
                              ht(bt({ type: ye.DomContentLoaded, data: {} })), 'DOMContentLoaded' === V && Me()
                          })
                      ),
                      Ae.push(
                          z(
    ...
    ;(At.addCustomEvent = function (e, t) {
        ...
        (At.takeFullSnapshot = function (e) {
            if (!St) throw new Error('please take full snapshot after start recording')
            gt(e)
        }),
        (At.mirror = wt)
    var kt = (function () {
        ...
        Ot = {
            ...
            parseV8OrIE: function (e) {
                return e.stack
                    ...
                    .map(function (e) {
                        ...
                        return new kt({ functionName: a, fileName: i, lineNumber: o[1], columnNumber: o[2] })
                    }, this)
            },
            parseFFOrSafari: function (e) {
                return e.stack
                    ...
                    .map(function (e) {
                        ...
                        return new kt({ functionName: r, fileName: o[0], lineNumber: o[1], columnNumber: o[2] })
                    }, this)
            },
            ...
            parseOpera10: function (e) {
                for (
                    ...
                    var i = t.exec(n[o])
                    i && r.push(new kt({ functionName: i[3] || void 0, fileName: i[2], lineNumber: parseFloat(i[1]) }))
                }
                return r
            },
                        ...
                        var t = e.split('@'),
                            ...
                            r =
                                (t.shift() || '')
                                    ...
                                    .replace(/\([^)]*\)/g, '') || void 0
                        return new kt({ functionName: r, fileName: n[0], lineNumber: n[1], columnNumber: n[2] })
                    }, this)
            },
        }
    function Et(e) {
        ...
        if (o.level.includes('error')) {
            ...
            var l = function (t) {
                ...
                t.reason instanceof Error
                    ? ((n = t.reason),
                      (r = [Lt('Uncaught (in promise) '.concat(n.name, ': ').concat(n.message), o.stringifyOptions)]))
                    : ((n = new Error()),
                      (r = [Lt('Uncaught (in promise)', o.stringifyOptions), Lt(t.reason, o.stringifyOptions)]))
                var a = Ot.parse(n).map(function (e) {
                    return e.toString()
                })
                                  ...
                                  ++i < o.lengthThreshold
                                      ...
                                      : i === o.lengthThreshold &&
                                        e({
                                            level: 'warn',
                                            trace: [],
                                            payload: [Lt('The number of log records reached the threshold.')],
                                        })
                              } catch (e) {
    ...
    null == Qt || Qt.document,
        null == Qt || Qt.location,
        null == Qt || Qt.fetch,
        null != Qt && Qt.XMLHttpRequest && 'withCredentials' in new Qt.XMLHttpRequest() && Qt.XMLHttpRequest,
    ...
    var en = null != zt ? zt : {},
        ...
        nn = {
            _log: function (e) {
                if (zt && en.POSTHOG_DEBUG && !jt(zt.console) && zt.console) {
                    for (
                        var t =
    ...
    function on(e, t, n) {
        if (!Pt(e)) {
                ...
                return (function (e, t, n) {
                    if (Zt(e))
                        if (Xt && e.forEach === Xt) e.forEach(t, n)
                            ...
                            for (var r = 0, o = e.length; r < o; r++) if (r in e && t.call(n, e[r], r) === rn) return
                })(e, t, n)
            if (Jt(e)) {
                var r,
                    o = g(e.entries())
            ...
            } else for (var i in e) if (Gt.call(e, i) && t.call(n, e[i], i) === rn) return
        }
    }
    var an = function (e) {
            var t,
            ...
            return (
                on(e, function (e, r) {
                    jt(e) ||
                        jt(r) ||
                        'undefined' === r ||
                        ((t = encodeURIComponent(e instanceof File ? e.name : e.toString())),
    ...
    function cn(e, t) {
        var n,
            ...
            o = { hostname: r, isHostDenied: !1 }
        if (null === (n = t.payloadHostDenyList) || void 0 === n || !n.length || null == r || !r.trim().length) return o
        var a,
            i = g(t.payloadHostDenyList)
        try {
            for (i.s(); !(a = i.n()).done; ) {
                var s = a.value
    ...
    function pn(e, t, n) {
        if (n.recordInitialRequests) {
            var r = t.performance.getEntries().filter(function (e) {
                return ln(e) || (dn(e) && n.initiatorTypes.includes(e.initiatorType))
            })
            e({
                requests: r.flatMap(function (e) {
                    return Cn({ entry: e, method: void 0, status: void 0, networkRequest: {}, isInitial: !0 })
                }),
                isInitial: !0,
            })
        }
        var o = new t.PerformanceObserver(function (t) {
                ...
                e({
                    requests: r.flatMap(function (e) {
                        return Cn({ entry: e, method: void 0, status: void 0, networkRequest: {} })
                    }),
                })
            }),
                    ...
                    return r().wrap(function (e) {
                        for (;;)
                            switch ((e.prev = e.next)) {
                                case 0:
                                    if (!((s = l.length > 5 && void 0 !== l[5] ? l[5] : 0) > 10)) {
                                        e.next = 4
                                        break
                                    }
                                    return (
                                ...
                                case 9:
                                    return e.abrupt('return', mn(t, n, o, a, i, s + 1))
                                case 10:
    ...
    function yn(e) {
        ...
        var o = cn(r, n),
            a = o.hostname
        if (o.isHostDenied) return a + ' is in deny list'
        if (_t(t)) return t
        if (qt(t)) return t.textContent
        if (Jt(t)) return an(t)
        if (Kt(t))
            try {
    ...
    var In = function (e) {
        return !Ht(e) && ('navigation' === e.entryType || 'resource' === e.entryType)
    }
    function Cn(e) {
        var t = e.entry,
            r = e.method,
            ...
            u = e.end,
            c = e.url
        ;(s = t ? t.startTime : s), (u = t ? t.responseEnd : u)
        var l = Math.floor(Date.now() - performance.now()),
            d = Math.floor(l + (s || 0)),
            f = [
                n(
                    n({}, t ? t.toJSON() : { name: c }),
                    {},
                    {
                        startTime: jt(s) ? void 0 : Math.round(s),
                        endTime: jt(u) ? void 0 : Math.round(u),
                        timeOrigin: l,
                        timestamp: d,
                        method: r,
                        initiatorType: t ? t.initiatorType : void 0,
                        status: o,
    ...
    function Sn(e) {
        ...
        var a = null === (t = n.headers.get('Content-Type')) || void 0 === t ? void 0 : t.toLowerCase(),
            i = bn.some(function (e) {
    ...
    function On(e, t, o) {
        ...
        if (Nn) return nn.warn('Network observer already initialised, doing nothing'), function () {}
        ...
        return (
            (a.recordHeaders || a.recordBody) &&
                ((c = (function (e, t, n) {
                    ...
                    var r = hn('request', n.recordHeaders),
                        o = hn('response', n.recordHeaders),
                        a = un(t.XMLHttpRequest.prototype, 'open', function (a) {
                            return function (i, s) {
                                var u,
                                    c,
                                ...
                                ;(p.send = function (e) {
                                    return (
                                        gn({ type: 'request', headers: m, url: s, recordBody: n.recordBody }) &&
                                            (g.requestBody = yn({ body: e, options: n, url: s })),
                                        (u = t.performance.now()),
                                        y(e)
                                    )
                                }),
                                    p.addEventListener('readystatechange', function () {
                                        if (p.readyState === p.DONE) {
                                            ...
                                            p
                                                ...
                                                }) && (g.responseBody = yn({ body: p.response, options: n, url: s })),
                                                mn(t, 'xmlhttprequest', h.url, u, c)
                                                    .then(function (t) {
                                                        var n = Cn({
                                                            entry: t,
                                                            method: h.method,
                ...
                (l = (function (e, t, n) {
                    ...
                    var o = hn('request', n.recordHeaders),
                        a = hn('response', n.recordHeaders),
                        s = un(t, 'fetch', function (s) {
                            return (function () {
                                var u = i(
                                                ...
                                                for (;;)
                                                    switch ((r.prev = r.next)) {
                                                        case 0:
                                                            ...
                                                            return (r.next = 9), An({ r: l, options: n, url: u })
                                                        case 9:
                                                            f.requestBody = r.sent
                                                        case 10:
                                                            return (p = t.performance.now()), (r.next = 13), s(l)
                                                        case 13:
                                                            if (
                                                                ((d = r.sent),
                                                                (h = t.performance.now()),
                                                            ...
                                                            return (r.next = 21), Mn({ r: d, options: n, url: u })
                                                        case 21:
    ...
    var En = 'rrweb/network@1',
        Rn = function (e) {
            return { name: En, observer: On, options: e }
        }
    zt &&
        ((zt.rrweb = { record: At, version: 'v2', rrwebVersion: '2.0.0-alpha.13' }),
        (zt.rrwebConsoleRecord = {
            getRecordConsolePlugin: function (e) {
                return { name: 'rrweb/console@1', observer: Dt, options: e }
            },
        }),
        (zt.getRecordNetworkPlugin = Rn)),
        (e.NETWORK_PLUGIN_NAME = En),
        (e.findLast = fn),
        (e.getRecordNetworkPlugin = Rn)
})({})
