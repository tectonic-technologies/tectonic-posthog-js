...
export declare function eachArray<E = any>(
...
export declare function _copyAndTruncateStrings<T extends Record<string, any> = Record<string, any>>(
    object: T,
...
export declare const registerEvent: (
