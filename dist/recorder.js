!(function (e) {
            ...
            case e.ELEMENT_NODE:
                return (function (e, t) {
                    for (
                        ...
                        j(b, x.name, x.value) || (M[x.name] = _(r, b, w(x.name), x.value))
                    }
                    if ('link' === b && i) {
                        var L = e.href,
    ...
    function J(e, t) {
        ...
        _ = r.hasNode(e)
            ...
            : !(function (e, t) {
              ...
              (K || j.type !== m.Text || j.isStyle || j.textContent.replace(/^\s+|\s+$/gm, '').length)
            ? x()
            : R
        var H = Object.assign(j, { id: _ })
        if ((r.add(e, H), _ === R)) return null
        T && T(e)
        var z = !c
        if (H.type === m.Element) {
                    ...
                    (this.emit = function () {
                        if (!t.frozen && !t.locked) {
                            ...
                            try {
                                for (s.s(); !(i = s.n()).done; ) {
                                    var u = i.value
                                    ;(Ne(t.removes, u, t.mirror) && !t.movedSet.has(u.parentNode)) || a(u)
                                }
                            } catch (e) {
                                s.e(e)
                            } finally {
                            ...
                            switch (e.type) {
                                ...
                                case 'attributes':
                                    ...
                                    if (
                                        ...
                                        !j(r.tagName, o) &&
                                            ((s.attributes[o] = _(t.doc, w(r.tagName), w(o), a)), 'style' === o))
                                    ) {
                                        if (!t.unattachedDoc)
                                            try {
                        ...
                        ;(p[a] = { insertRule: i.prototype.insertRule, deleteRule: i.prototype.deleteRule }),
                                    ...
                                    return (
                                        ((l && -1 !== l) || (p && -1 !== p)) &&
                                            n({
                                                id: l,
                                                styleId: p,
                                                adds: [{ rule: s, index: [].concat(f(_e(t)), [u || 0]) }],
                                            }),
                                        e.apply(t, a)
                                    )
                                }),
                            ...
                            (i.prototype.deleteRule = new Proxy(p[a].deleteRule, {
                                apply: De(function (e, t, a) {
                                    ...
                                    return (
                                        ((u && -1 !== u) || (c && -1 !== c)) &&
                                            n({ id: u, styleId: c, removes: [{ index: [].concat(f(_e(t)), [i]) }] }),
                                        e.apply(t, a)
                                    )
                                }),
                            }))
                ...
                return (
                    (i.CSSStyleDeclaration.prototype.removeProperty = new Proxy(u, {
                        apply: De(function (e, t, i) {
                            ...
                            return (
                                ((f && -1 !== f) || (p && -1 !== p)) &&
                                    n({ id: f, styleId: p, remove: { property: c }, index: _e(t.parentRule) }),
                                e.apply(t, i)
                            )
                        }),
                    })),
  ...
  ***************************************************************************** */
    ...
    function At() {
        ...
        void 0 !== R && void 0 === O.mousemove && (O.mousemove = R), wt.reset()
        var te,
            ne =
                !0 === I
                    ? {
        ...
        var l = Math.floor(Date.now() - performance.now()),
            ...
            f = [
                n(
                    ...
                    {},
                    {
                        startTime: _t(s) ? void 0 : Math.round(s),
                        endTime: _t(u) ? void 0 : Math.round(u),
                        timeOrigin: l,
                        timestamp: d,
                        method: r,
    ...
    function Nn(e, t, o) {
        ...
        if (On) return nn.warn('Network observer already initialised, doing nothing'), function () {}
    ...
    var En = 'rrweb/network@1',
        Rn = function (e) {
            return { name: En, observer: Nn, options: e }
        }
    zt &&
