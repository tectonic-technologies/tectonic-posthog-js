...
export var surveyUrlValidationMap = {
    ...
    regex: function (conditionsUrl) {
        return !!window && isUrlMatchingRegex(window.location.href, conditionsUrl)
    },
    not_regex: function (conditionsUrl) {
        return !!window && !isUrlMatchingRegex(window.location.href, conditionsUrl)
    },
    exact: function (conditionsUrl) {
        return (window === null || window === void 0 ? void 0 : window.location.href) === conditionsUrl
    },
    is_not: function (conditionsUrl) {
        return (window === null || window === void 0 ? void 0 : window.location.href) !== conditionsUrl
    },
}
...
var PostHogSurveys = /** @class */ (function () {
    ...
    PostHogSurveys.prototype.loadIfEnabled = function () {
        var _this = this
        var surveysGenerator =
            assignableWindow === null || assignableWindow === void 0
                ? void 0
                : assignableWindow.extendPostHogWithSurveys
            ...
            this.instance._send_request({
                ...
                callback: function (response) {
                    ...
                    var eventOrActionBasedSurveys = surveys.filter(function (survey) {
                        ...
                        return (
                            (((_a = survey.conditions) === null || _a === void 0 ? void 0 : _a.events) &&
                                ((_c = (_b = survey.conditions) === null || _b === void 0 ? void 0 : _b.events) ===
                                    null || _c === void 0
                                    ? void 0
                                    : _c.values) &&
                                ((_f =
                                    (_e = (_d = survey.conditions) === null || _d === void 0 ? void 0 : _d.events) ===
                                        null || _e === void 0
                                        ? void 0
                            ...
                            (((_g = survey.conditions) === null || _g === void 0 ? void 0 : _g.actions) &&
                                ((_j = (_h = survey.conditions) === null || _h === void 0 ? void 0 : _h.actions) ===
                                    null || _j === void 0
                                    ? void 0
                                    : _j.values) &&
                                ((_m =
                                    (_l = (_k = survey.conditions) === null || _k === void 0 ? void 0 : _k.actions) ===
                                        null || _l === void 0
                                        ? void 0
                                        : _l.values) === null || _m === void 0
                                    ? void 0
                                    : _m.length) > 0)
                        )
                    })
                    if (eventOrActionBasedSurveys.length > 0) {
                        ;(_b = _this._surveyEventReceiver) === null || _b === void 0
                            ? void 0
                            : _b.register(eventOrActionBasedSurveys)
                    }
                    ;(_c = _this.instance.persistence) === null || _c === void 0
                        ? void 0
                        : _c.register(((_a = {}), (_a[SURVEYS] = surveys), _a))
        ...
        this.getSurveys(function (surveys) {
            ...
            var conditionMatchedSurveys = activeSurveys.filter(function (survey) {
                ...
                var urlCheck = ((_a = survey.conditions) === null || _a === void 0 ? void 0 : _a.url)
                    ? surveyUrlValidationMap[
                          (_c = (_b = survey.conditions) === null || _b === void 0 ? void 0 : _b.urlMatchType) !==
                              null && _c !== void 0
                              ? _c
                              : 'icontains'
            ...
            var activatedSurveys =
                (_a = _this._surveyEventReceiver) === null || _a === void 0 ? void 0 : _a.getSurveys()
            var targetingMatchedSurveys = conditionMatchedSurveys.filter(function (survey) {
                ...
                var hasEvents =
                    ((_a = survey.conditions) === null || _a === void 0 ? void 0 : _a.events) &&
                    ((_c = (_b = survey.conditions) === null || _b === void 0 ? void 0 : _b.events) === null ||
                    _c === void 0
                        ? void 0
                        : _c.values) &&
                    ((_e = (_d = survey.conditions) === null || _d === void 0 ? void 0 : _d.events) === null ||
                    _e === void 0
                        ? void 0
                        : _e.values.length) > 0
                var hasActions =
                    ((_f = survey.conditions) === null || _f === void 0 ? void 0 : _f.actions) &&
                    ((_h = (_g = survey.conditions) === null || _g === void 0 ? void 0 : _g.actions) === null ||
                    _h === void 0
                        ? void 0
                        : _h.values) &&
                    ((_k = (_j = survey.conditions) === null || _j === void 0 ? void 0 : _j.actions) === null ||
                    _k === void 0
                        ? void 0
                        : _k.values.length) > 0
                var eventBasedTargetingFlagCheck =
                    hasEvents || hasActions
                        ? activatedSurveys === null || activatedSurveys === void 0
                            ? void 0
                            : activatedSurveys.includes(survey.id)
                        : true
                var overrideInternalTargetingFlagCheck = _this._canActivateRepeatedly(survey)
                var internalTargetingFlagCheck =
    ...
    PostHogSurveys.prototype._canActivateRepeatedly = function (survey) {
        ...
        if (
            isNullish(
                (_a = assignableWindow.__PosthogExtensions__) === null || _a === void 0
                    ? void 0
                    : _a.canActivateRepeatedly
            )
        ) {
    ...
    PostHogSurveys.prototype.canRenderSurvey = function (surveyId) {
        ...
        this.getSurveys(function (surveys) {
            var survey = surveys.filter(function (x) {
                return x.id === surveyId
            })[0]
    ...
    PostHogSurveys.prototype.renderSurvey = function (surveyId, selector) {
        ...
        this.getSurveys(function (surveys) {
            ...
            _this._surveyManager.renderSurvey(
                survey,
                document === null || document === void 0 ? void 0 : document.querySelector(selector)
            )
        })
    }
