...
var SessionIdManager = /** @class */ (function () {
    ...
    SessionIdManager.prototype.onSessionId = function (callback) {
        ...
        return function () {
            _this._sessionIdChangedHandlers = _this._sessionIdChangedHandlers.filter(function (h) {
                return h !== callback
            })
        }
    }
    ...
    SessionIdManager.prototype._setSessionId = function (sessionId, sessionActivityTimestamp, sessionStartTimestamp) {
        ...
        if (
            ...
            this.persistence.register(
                ((_a = {}), (_a[SESSION_ID] = [sessionActivityTimestamp, sessionId, sessionStartTimestamp]), _a)
            )
        }
    }
    ...
    SessionIdManager.prototype.checkAndGetSessionAndWindowId = function (readOnly, _timestamp) {
        ...
        var _a = __read(this._getSessionId(), 3),
            lastTimestamp = _a[0],
            sessionId = _a[1],
            startTimestamp = _a[2]
        ...
        if (noSessionId || activityTimeout || sessionPastMaximumLength) {
            ...
            logger.info('[SessionId] new session ID generated', {
                ...
                changeReason: {
                    ...
                    sessionPastMaximumLength: sessionPastMaximumLength,
                },
            })
        ...
        if (valuesChanged) {
            this._sessionIdChangedHandlers.forEach(function (handler) {
                return handler(sessionId, windowId)
            })
        }
        return {
            sessionId: sessionId,
