...
export var defaultConfig = function () {
    ...
    return {
        ...
        autocapture: true,
        rageclick: true,
        cross_subdomain_cookie: isCrossDomainCookie(
        ...
        debug:
            (location &&
                isString(location === null || location === void 0 ? void 0 : location.search) &&
                location.search.indexOf('__posthog_debug=true') !== -1) ||
            false,
        verbose: false,
...
export var configRenames = function (origConfig) {
    ...
    if (isArray(origConfig.property_blacklist)) {
        if (isUndefined(origConfig.property_denylist)) {
            ...
            newConfig.property_denylist = __spreadArray(
                __spreadArray([], __read(origConfig.property_blacklist), false),
                __read(origConfig.property_denylist),
                false
            )
        } else {
...
var PostHog = /** @class */ (function () {
    function PostHog() {
        ...
        this.sentryIntegration = function (options) {
            return sentryIntegration(_this, options)
        }
        ...
        this.on('eventCaptured', function (data) {
            return logger.info('send', data)
        })
    }
    ...
    PostHog.prototype._init = function (token, config, name) {
        ...
        this._requestQueue = new RequestQueue(function (req) {
            return _this._send_retriable_request(req)
        })
        ...
        if (((_a = config.bootstrap) === null || _a === void 0 ? void 0 : _a.distinctID) !== undefined) {
            ...
            var deviceID = ((_b = config.bootstrap) === null || _b === void 0 ? void 0 : _b.isIdentifiedID)
                ? uuid
                : config.bootstrap.distinctID
            this.persistence.set_property(
                USER_STATE,
                ((_c = config.bootstrap) === null || _c === void 0 ? void 0 : _c.isIdentifiedID)
                    ? 'identified'
                    : 'anonymous'
            )
            this.register({
        ...
        if (this._hasBootstrappedFeatureFlags()) {
            var activeFlags_1 = Object.keys(
                ((_d = config.bootstrap) === null || _d === void 0 ? void 0 : _d.featureFlags) || {}
            )
                .filter(function (flag) {
                    var _a, _b
                    return !!((_b = (_a = config.bootstrap) === null || _a === void 0 ? void 0 : _a.featureFlags) ===
                        null || _b === void 0
                        ? void 0
                        : _b[flag])
                })
                .reduce(function (res, key) {
                    ...
                    return (
                        (res[key] =
                            ((_b = (_a = config.bootstrap) === null || _a === void 0 ? void 0 : _a.featureFlags) ===
                                null || _b === void 0
                                ? void 0
                                : _b[key]) || false),
                        res
            ...
            var featureFlagPayloads = Object.keys(
                ((_e = config.bootstrap) === null || _e === void 0 ? void 0 : _e.featureFlagPayloads) || {}
            )
                .filter(function (key) {
                    return activeFlags_1[key]
                })
                .reduce(function (res, key) {
                    var _a, _b, _c, _d
                    if (
                        (_b = (_a = config.bootstrap) === null || _a === void 0 ? void 0 : _a.featureFlagPayloads) ===
                            null || _b === void 0
                            ? void 0
                            : _b[key]
                    ) {
                        res[key] =
                            (_d =
                                (_c = config.bootstrap) === null || _c === void 0 ? void 0 : _c.featureFlagPayloads) ===
                                null || _d === void 0
                                ? void 0
                                : _d[key]
                    }
        ...
        ;(_f = window === null || window === void 0 ? void 0 : window.addEventListener) === null || _f === void 0
            ? void 0
            : _f.call(window, 'onpagehide' in self ? 'pagehide' : 'unload', this._handle_unload.bind(this))
        this.toolbar.maybeLoadToolbar()
        // We wan't to avoid promises for IE11 compatibility, so we use callbacks here
        if (config.segment) {
            setupSegmentIntegration(this, function () {
        ...
        if (isFunction(this.config._onCapture)) {
            this.on('eventCaptured', function (data) {
                return _this.config._onCapture(data.event, data)
            })
        }
        return this
    }
    ...
    PostHog.prototype._dom_loaded = function () {
        var _this = this
        if (!this.has_opted_out_capturing()) {
            eachArray(this.__request_queue, function (item) {
                return _this._send_retriable_request(item)
            })
        }
        this.__request_queue = []
        this._start_queue_if_opted_in()
            ...
            __assign(__assign({}, options), {
                callback: function (response) {
                    ...
                    if (response.statusCode >= 400) {
                        ;(_b = (_a = _this.config).on_request_error) === null || _b === void 0
                            ? void 0
                            : _b.call(_a, response)
                    }
    ...
    PostHog.prototype._hasBootstrappedFeatureFlags = function () {
        var _a, _b
        return (
            (((_a = this.config.bootstrap) === null || _a === void 0 ? void 0 : _a.featureFlags) &&
                Object.keys((_b = this.config.bootstrap) === null || _b === void 0 ? void 0 : _b.featureFlags).length >
                    0) ||
            false
        )
    }
    ...
    PostHog.prototype.capture = function (event_name, properties, options) {
        ...
        var clientRateLimitContext = !(options === null || options === void 0
            ? void 0
            : options.skip_client_rate_limiting)
            ? this.rateLimiter.clientRateLimitContext()
            : undefined
        if (
            clientRateLimitContext === null || clientRateLimitContext === void 0
                ? void 0
                : clientRateLimitContext.isRateLimited
        ) {
        ...
        var setOnceProperties = this._calculate_set_once_properties(
            options === null || options === void 0 ? void 0 : options.$set_once
        )
        ...
        data = _copyAndTruncateStrings(
            data,
            (options === null || options === void 0 ? void 0 : options._noTruncate)
                ? null
        ...
        var requestOptions = {
            method: 'POST',
            url:
                (_a = options === null || options === void 0 ? void 0 : options._url) !== null && _a !== void 0
                    ? _a
                    : this.requestRouter.endpointFor('api', this.analyticsDefaultEndpoint),
            data: data,
            compression: Compression.Base64, //'best-available',
    ...
    PostHog.prototype._addCaptureHook = function (callback) {
        return this.on('eventCaptured', function (data) {
            return callback(data.event, data)
        })
    }
    PostHog.prototype._calculate_event_properties = function (event_name, event_properties, timestamp) {
        ...
        if (event_name === '$snapshot') {
            var persistenceProps = __assign(
                __assign({}, this.persistence.properties()),
        ...
        if (this.sessionManager) {
            var _a = this.sessionManager.checkAndGetSessionAndWindowId(),
    ...
    PostHog.prototype.onSessionId = function (callback) {
        var _a, _b
        return (_b = (_a = this.sessionManager) === null || _a === void 0 ? void 0 : _a.onSessionId(callback)) !==
            null && _b !== void 0
            ? _b
            : function () {}
    }
    ...
    PostHog.prototype.get_session_id = function () {
        ...
        return (_b =
            (_a = this.sessionManager) === null || _a === void 0
                ? void 0
                : _a.checkAndGetSessionAndWindowId(true).sessionId) !== null && _b !== void 0
            ? _b
            : ''
    }
    /**
    ...
    PostHog.prototype.get_session_replay_url = function (options) {
        ...
        var _b = this.sessionManager.checkAndGetSessionAndWindowId(true),
            sessionId = _b.sessionId,
            sessionStartTimestamp = _b.sessionStartTimestamp
        var url = this.requestRouter.endpointFor(
            'ui',
            '/project/'.concat(this.config.token, '/replay/').concat(sessionId)
        )
        if ((options === null || options === void 0 ? void 0 : options.withTimestamp) && sessionStartTimestamp) {
            ...
            var recordingStartTime = Math.max(
    ...
    PostHog.prototype.startSessionRecording = function (override) {
        ...
        if (overrideAll || (override === null || override === void 0 ? void 0 : override.sampling)) {
            ...
            ;(_c = this.persistence) === null || _c === void 0
                ? void 0
                : _c.register(
                      ((_a = {}),
            ...
            logger.info(
                ...
                ids === null || ids === void 0 ? void 0 : ids.sessionId
            )
        }
    ...
    PostHog.prototype.captureException = function (error, additionalProperties) {
        var properties = isFunction(assignableWindow.parseErrorAsProperties)
            ...
            : __assign(
                  { $exception_type: error.name, $exception_message: error.message, $exception_level: 'error' },
     ...
     */
    PostHog.prototype.get_properties = function () {
        var _a
        return (_a = this.persistence) === null || _a === void 0 ? void 0 : _a.props
    }
    /**
    ...
    PostHog.prototype._isIdentified = function () {
        var _a, _b
        return (
            ((_a = this.persistence) === null || _a === void 0 ? void 0 : _a.get_property(USER_STATE)) ===
                'identified' ||
            ((_b = this.sessionPersistence) === null || _b === void 0 ? void 0 : _b.get_property(USER_STATE)) ===
                'identified'
        )
    }
    PostHog.prototype._hasPersonProcessing = function () {
        ...
        return !(
            ...
            (this.config.person_profiles === 'identified_only' &&
                ...
                !((_b = (_a = this.persistence) === null || _a === void 0 ? void 0 : _a.props) === null || _b === void 0
                    ? void 0
                    : _b[ALIAS_ID_KEY]) &&
                !((_d = (_c = this.persistence) === null || _c === void 0 ? void 0 : _c.props) === null || _d === void 0
                    ? void 0
                    : _d[ENABLE_PERSON_PROCESSING]))
        )
    }
    ...
    PostHog.prototype.opt_in_capturing = function (options) {
        ...
        if (
            isUndefined(options === null || options === void 0 ? void 0 : options.captureEventName) ||
            (options === null || options === void 0 ? void 0 : options.captureEventName)
        ) {
            this.capture(
                (_a = options === null || options === void 0 ? void 0 : options.captureEventName) !== null &&
                    _a !== void 0
                    ? _a
                    : '$opt_in',
                options === null || options === void 0 ? void 0 : options.captureProperties,
                { send_instantly: true }
            )
        }
        if (this.config.capture_pageview) {
