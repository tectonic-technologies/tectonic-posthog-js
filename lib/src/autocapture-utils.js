...
function checkIfElementTreePassesElementAllowList(elements, autocaptureConfig) {
    var e_1, _a
    var allowlist =
        autocaptureConfig === null || autocaptureConfig === void 0 ? void 0 : autocaptureConfig.element_allowlist
    ...
    var _loop_1 = function (el) {
        if (
            allowlist.some(function (elementType) {
...
function checkIfElementTreePassesCSSSelectorAllowList(elements, autocaptureConfig) {
    var e_2, _a
    var allowlist =
        autocaptureConfig === null || autocaptureConfig === void 0 ? void 0 : autocaptureConfig.css_selector_allowlist
    if (isUndefined(allowlist)) {
        // everything is allowed, when there is no allow list
        return true
    }
    var _loop_2 = function (el) {
        if (
            allowlist.some(function (selector) {
    ...
    try {
        ...
        // if any of the elements are in the allow list, then the tree is allowed
        for (
            var elements_2 = __values(elements), elements_2_1 = elements_2.next();
            !elements_2_1.done;
...
export function shouldCaptureDomEvent(el, event, autocaptureConfig, captureOnAnyElement, allowedEventTypes) {
    ...
    if (autocaptureConfig === null || autocaptureConfig === void 0 ? void 0 : autocaptureConfig.dom_event_allowlist) {
        ...
        if (
            allowlist &&
            !allowlist.some(function (eventType) {
...
function elementsToString(elements) {
    var ret = elements.map(function (element) {
        ...
        var attributes = __assign(
            __assign(
                __assign(
                    __assign(__assign({}, element.text ? { text: element.text } : {}), {
                        'nth-child': (_b = element.nth_child) !== null && _b !== void 0 ? _b : 0,
                        'nth-of-type': (_c = element.nth_of_type) !== null && _c !== void 0 ? _c : 0,
                    }),
