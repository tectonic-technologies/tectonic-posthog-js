...
var xhr = function (options) {
    ...
    var _b = (_a = encodePostData(options)) !== null && _a !== void 0 ? _a : {},
    ...
    fetch(url, {
        ...
        .catch(function (error) {
            ...
            ;(_a = options.callback) === null || _a === void 0
                ? void 0
                : _a.call(options, { statusCode: 0, text: error })
        })
        .finally(function () {
            return aborter ? clearTimeout(aborter.timeout) : null
        })
    return
}
...
export var request = function (_options) {
    ...
    var transportMethod =
        (_c =
            (_b = find(AVAILABLE_TRANSPORTS, function (t) {
                return t.transport === transport
            })) === null || _b === void 0
                ? void 0
                : _b.method) !== null && _c !== void 0
            ? _c
            : AVAILABLE_TRANSPORTS[0].method
    if (!transportMethod) {
