...
var wrapOnError = function (captureFn) {
    ...
    win.onerror = function () {
        ...
        return (_a =
            originalOnError === null || originalOnError === void 0
                ? void 0
                : originalOnError.apply(void 0, __spreadArray([], __read(args), false))) !== null && _a !== void 0
            ? _a
            : false
    }
...
var wrapUnhandledRejection = function (captureFn) {
    ...
    win.onunhandledrejection = function () {
        ...
        captureFn(errorProperties)
        return (_a =
            originalOnUnhandledRejection === null || originalOnUnhandledRejection === void 0
                ? void 0
                : originalOnUnhandledRejection.apply(win, args)) !== null && _a !== void 0
            ? _a
            : false
    }
