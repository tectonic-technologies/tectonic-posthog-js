...
var Autocapture = /** @class */ (function () {
    ...
    Object.defineProperty(Autocapture.prototype, 'config', {
        get: function () {
            ...
            config.url_allowlist =
                (_a = config.url_allowlist) === null || _a === void 0
                    ? void 0
                    : _a.map(function (url) {
                          return new RegExp(url)
                      })
            config.url_ignorelist =
                (_b = config.url_ignorelist) === null || _b === void 0
                    ? void 0
                    : _b.map(function (url) {
                          return new RegExp(url)
                      })
    ...
    Autocapture.prototype.afterDecideResponse = function (response) {
        ...
        if (this.instance.persistence) {
            this.instance.persistence.register(
                ((_a = {}), (_a[AUTOCAPTURE_DISABLED_SERVER_SIDE] = !!response['autocapture_opt_out']), _a)
            )
        }
    ...
    Autocapture.prototype.getElementSelectors = function (element) {
        ...
        ;(_a = this._elementSelectors) === null || _a === void 0
            ? void 0
            : _a.forEach(function (selector) {
                  var matchedElements =
                      document === null || document === void 0 ? void 0 : document.querySelectorAll(selector)
                  matchedElements === null || matchedElements === void 0
                      ? void 0
    ...
    Object.defineProperty(Autocapture.prototype, 'isEnabled', {
        get: function () {
            var _a, _b
            var persistedServerDisabled =
                (_a = this.instance.persistence) === null || _a === void 0
                    ? void 0
                    : _a.props[AUTOCAPTURE_DISABLED_SERVER_SIDE]
            ...
            var disabledServer =
                (_b = this._isDisabledServerSide) !== null && _b !== void 0 ? _b : !!persistedServerDisabled
    ...
    Autocapture.prototype._getPropertiesFromElement = function (elem, maskInputs, maskText) {
        ...
        var elementAttributeIgnorelist =
            (_a = this.config) === null || _a === void 0 ? void 0 : _a.element_attribute_ignorelist
        each(elem.attributes, function (attr) {
            // Only capture attributes we know are safe
            if (isSensitiveElement(elem) && ['name', 'id', 'class', 'aria-label'].indexOf(attr.name) === -1) return
            if (
                elementAttributeIgnorelist === null || elementAttributeIgnorelist === void 0
                    ? void 0
                    : elementAttributeIgnorelist.includes(attr.name)
            )
                return
    ...
    Autocapture.prototype._captureEvent = function (e, eventName) {
        ...
        if (eventName === '$autocapture' && e.type === 'click' && e instanceof MouseEvent) {
            if (
                ...
                ((_a = this.rageclicks) === null || _a === void 0
                    ? void 0
                    : _a.isRageClick(e.clientX, e.clientY, new Date().getTime()))
            ) {
        ...
        if (
            ...
            each(targetElementList, function (el) {
                ...
                elementsJson_1.push(
                    _this._getPropertiesFromElement(
                        el,
                        _this.instance.config.mask_all_element_attributes,
                        _this.instance.config.mask_all_text
                    )
                )
            ...
            if (href_1) {
                ...
                var locationHost =
                    (_c = window === null || window === void 0 ? void 0 : window.location) === null || _c === void 0
                        ? void 0
                        : _c.host
            ...
            var props = extend(
                ...
                ((_d = elementsJson_1[0]) === null || _d === void 0 ? void 0 : _d['$el_text'])
                    ? { $el_text: (_e = elementsJson_1[0]) === null || _e === void 0 ? void 0 : _e['$el_text'] }
                    : {},
                externalHref && e.type === 'click' ? { $external_click_url: externalHref } : {},
                autocaptureAugmentProperties_1
            )
            ...
            if (eventName === COPY_AUTOCAPTURE_EVENT) {
                ...
                var selectedContent = makeSafeText(
                    (_f = window === null || window === void 0 ? void 0 : window.getSelection()) === null ||
                        _f === void 0
                        ? void 0
                        : _f.toString()
                )
