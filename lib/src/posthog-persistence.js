...
var CASE_INSENSITIVE_PERSISTENCE_TYPES = ['cookie', 'localstorage', 'localstorage+cookie', 'sessionstorage', 'memory']
...
var PostHogPersistence = /** @class */ (function () {
    ...
    PostHogPersistence.prototype.set_initial_person_info = function () {
        ...
        this.register_once(((_a = {}), (_a[INITIAL_PERSON_INFO] = Info.initialPersonInfo()), _a), undefined)
    }
