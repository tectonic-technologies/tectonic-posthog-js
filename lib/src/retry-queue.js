...
var RetryQueue = /** @class */ (function () {
    ...
    RetryQueue.prototype.retriableRequest = function (_a) {
        var _this = this
        var retriesPerformedSoFar = _a.retriesPerformedSoFar,
            ...
            __assign(__assign({}, options), {
                callback: function (response) {
                    ...
                    if (response.statusCode !== 200 && (response.statusCode < 400 || response.statusCode >= 500)) {
                        if (
                            (retriesPerformedSoFar !== null && retriesPerformedSoFar !== void 0
    ...
    RetryQueue.prototype.flush = function () {
        ...
        if (toFlush.length > 0) {
            try {
                for (
                    var toFlush_1 = __values(toFlush), toFlush_1_1 = toFlush_1.next();
                    !toFlush_1_1.done;
                    toFlush_1_1 = toFlush_1.next()
                ) {
