...
var ScrollManager = /** @class */ (function () {
    function ScrollManager(instance) {
        ...
        this._updateScrollData = function () {
            ...
            _this.context.maxScrollY = Math.max(
                scrollY,
                (_a = _this.context.maxScrollY) !== null && _a !== void 0 ? _a : 0
            )
            _this.context.maxScrollHeight = Math.max(
                scrollHeight,
                (_b = _this.context.maxScrollHeight) !== null && _b !== void 0 ? _b : 0
            )
            _this.context.lastContentY = contentY
            _this.context.maxContentY = Math.max(
                contentY,
                (_c = _this.context.maxContentY) !== null && _c !== void 0 ? _c : 0
            )
            _this.context.maxContentHeight = Math.max(
                contentHeight,
                (_d = _this.context.maxContentHeight) !== null && _d !== void 0 ? _d : 0
            )
        }
    }
    ...
    ScrollManager.prototype.scrollElement = function () {
        ...
        if (this.instance.config.scroll_root_selector) {
            ...
            try {
                for (
                    var selectors_1 = __values(selectors), selectors_1_1 = selectors_1.next();
                    !selectors_1_1.done;
                    selectors_1_1 = selectors_1.next()
                ) {
                    var selector = selectors_1_1.value
                    var element =
                        window === null || window === void 0 ? void 0 : window.document.querySelector(selector)
                    if (element) {
                        return element
                    }
                }
