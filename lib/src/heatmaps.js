...
function elementOrParentPositionMatches(el, matches, breakOnElement) {
    ...
    while (curEl && !isTag(curEl, 'body')) {
        ...
        if (
            includes(matches, window === null || window === void 0 ? void 0 : window.getComputedStyle(curEl).position)
        ) {
            return true
        }
...
function elementInToolbar(el) {
    ...
    return (
        el.id === TOOLBAR_ID || !!((_a = el.closest) === null || _a === void 0 ? void 0 : _a.call(el, '#' + TOOLBAR_ID))
    )
}
var Heatmaps = /** @class */ (function () {
    function Heatmaps(instance) {
        ...
        this._enabledServerSide = !!((_a = this.instance.persistence) === null || _a === void 0
            ? void 0
            : _a.props[HEATMAPS_ENABLED_SERVER_SIDE])
    ...
    Heatmaps.prototype.afterDecideResponse = function (response) {
        ...
        if (this.instance.persistence) {
            this.instance.persistence.register(((_a = {}), (_a[HEATMAPS_ENABLED_SERVER_SIDE] = optIn), _a))
        }
    ...
    Heatmaps.prototype._setupListeners = function () {
        ...
        registerEvent(
            ...
            'click',
            function (e) {
                return _this._onClick(e || (window === null || window === void 0 ? void 0 : window.event))
            },
            false,
            true
        )
        registerEvent(
            ...
            'mousemove',
            function (e) {
                return _this._onMouseMove(e || (window === null || window === void 0 ? void 0 : window.event))
            },
            false,
            true
        )
