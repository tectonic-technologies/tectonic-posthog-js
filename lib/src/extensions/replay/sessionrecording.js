...
var newQueuedEvent = function (rrwebMethod) {
    return {
...
var SessionRecording = /** @class */ (function () {
    ...
    Object.defineProperty(SessionRecording.prototype, 'rrwebRecord', {
        get: function () {
            var _a
            return (_a = assignableWindow === null || assignableWindow === void 0 ? void 0 : assignableWindow.rrweb) ===
                null || _a === void 0
                ? void 0
                : _a.record
        },
    ...
    Object.defineProperty(SessionRecording.prototype, 'fullSnapshotIntervalMillis', {
        get: function () {
            var _a
            return (
                ((_a = this.instance.config.session_recording) === null || _a === void 0
                    ? void 0
                    : _a.full_snapshot_interval_millis) || FIVE_MINUTES
            )
        },
        enumerable: false,
        configurable: true,
    ...
    Object.defineProperty(SessionRecording.prototype, 'sessionDuration', {
        get: function () {
            ...
            var mostRecentSnapshot =
                (_a = this.buffer) === null || _a === void 0
                    ? void 0
                    : _a.data[((_b = this.buffer) === null || _b === void 0 ? void 0 : _b.data.length) - 1]
    ...
    Object.defineProperty(SessionRecording.prototype, 'isConsoleLogCaptureEnabled', {
        get: function () {
            ...
            return enabled_client_side !== null && enabled_client_side !== void 0
                ? enabled_client_side
                : enabled_server_side
        },
        enumerable: false,
    ...
    Object.defineProperty(SessionRecording.prototype, 'networkPayloadCapture', {
        ...
        get: function () {
            var _a, _b
            var networkPayloadCapture_server_side = this.instance.get_property(
                SESSION_RECORDING_NETWORK_PAYLOAD_CAPTURE
            )
            var networkPayloadCapture_client_side = {
                recordHeaders:
                    (_a = this.instance.config.session_recording) === null || _a === void 0 ? void 0 : _a.recordHeaders,
                recordBody:
                    (_b = this.instance.config.session_recording) === null || _b === void 0 ? void 0 : _b.recordBody,
            }
            var headersEnabled =
                (networkPayloadCapture_client_side === null || networkPayloadCapture_client_side === void 0
                    ? void 0
                    : networkPayloadCapture_client_side.recordHeaders) ||
                (networkPayloadCapture_server_side === null || networkPayloadCapture_server_side === void 0
                    ? void 0
                    : networkPayloadCapture_server_side.recordHeaders)
            var bodyEnabled =
                (networkPayloadCapture_client_side === null || networkPayloadCapture_client_side === void 0
                    ? void 0
                    : networkPayloadCapture_client_side.recordBody) ||
                (networkPayloadCapture_server_side === null || networkPayloadCapture_server_side === void 0
                    ? void 0
                    : networkPayloadCapture_server_side.recordBody)
    ...
    SessionRecording.prototype.makeSamplingDecision = function (sessionId) {
        ...
        if (!isNumber(currentSampleRate)) {
            ;(_c = this.instance.persistence) === null || _c === void 0
                ? void 0
                : _c.register(((_a = {}), (_a[SESSION_RECORDING_IS_SAMPLED] = null), _a))
            return
        }
        ...
        if (!shouldSample && makeDecision) {
            logger.warn(
                LOGGER_PREFIX +
                    ' Sample rate ('
                        .concat(currentSampleRate, ') has determined that this sessionId (')
                        .concat(sessionId, ') will not be sent to the server.')
            )
        }
        this._tryAddCustomEvent('samplingDecisionMade', {
            sampleRate: currentSampleRate,
        })
        ;(_d = this.instance.persistence) === null || _d === void 0
            ? void 0
            : _d.register(((_b = {}), (_b[SESSION_RECORDING_IS_SAMPLED] = shouldSample), _b))
    }
    ...
    SessionRecording.prototype._persistDecideResponse = function (response) {
        if (this.instance.persistence) {
            ...
            var persistResponse = function () {
                ...
                var receivedSampleRate =
                    (_b = response.sessionRecording) === null || _b === void 0 ? void 0 : _b.sampleRate
                var parsedSampleRate = isNullish(receivedSampleRate) ? null : parseFloat(receivedSampleRate)
                var receivedMinimumDuration =
                    (_c = response.sessionRecording) === null || _c === void 0 ? void 0 : _c.minimumDurationMilliseconds
                persistence_1.register(
                    ((_a = {}),
                    (_a[SESSION_RECORDING_ENABLED_SERVER_SIDE] = !!response['sessionRecording']),
                    (_a[CONSOLE_LOG_RECORDING_ENABLED_SERVER_SIDE] =
                        (_d = response.sessionRecording) === null || _d === void 0
                            ? void 0
                            : _d.consoleLogRecordingEnabled),
                    (_a[SESSION_RECORDING_NETWORK_PAYLOAD_CAPTURE] = __assign(
                        { capturePerformance: response.capturePerformance },
                        (_e = response.sessionRecording) === null || _e === void 0 ? void 0 : _e.networkPayloadCapture
                    )),
    ...
    SessionRecording.prototype.log = function (message, level) {
        ...
        ;(_a = this.instance.sessionRecording) === null || _a === void 0
            ? void 0
            : _a.onRRwebEmit({
                  type: 6,
                  data: {
    ...
    SessionRecording.prototype._updateWindowAndSessionIds = function (event) {
        ...
        var _a = this.sessionManager.checkAndGetSessionAndWindowId(!isUserInteraction, event.timestamp),
            windowId = _a.windowId,
            sessionId = _a.sessionId
        var sessionIdChanged = this.sessionId !== sessionId
    ...
    SessionRecording.prototype._tryAddCustomEvent = function (tag, payload) {
        ...
        return this._tryRRWebMethod(
            newQueuedEvent(function () {
                return _this.rrwebRecord.addCustomEvent(tag, payload)
            })
        )
    }
    SessionRecording.prototype._tryTakeFullSnapshot = function () {
        ...
        return this._tryRRWebMethod(
            newQueuedEvent(function () {
                return _this.rrwebRecord.takeFullSnapshot()
            })
        )
    }
    SessionRecording.prototype._onScriptLoaded = function () {
        ...
        try {
            for (
                var _c = __values(Object.entries(userSessionRecordingOptions || {})), _d = _c.next();
                !_d.done;
                _d = _c.next()
            ) {
        ...
        this.mutationRateLimiter =
            (_b = this.mutationRateLimiter) !== null && _b !== void 0
                ? _b
                : new MutationRateLimiter(this.rrwebRecord, {
                      onBlockedNode: function (id, node) {
                          var message = "Too many mutations on node '".concat(
                              id,
        ...
        this._tryAddCustomEvent('$session_options', {
            ...
            activePlugins: activePlugins.map(function (p) {
    ...
    SessionRecording.prototype.onRRwebEmit = function (rawEvent) {
        ...
        var throttledEvent = this.mutationRateLimiter ? this.mutationRateLimiter.throttleMutations(rawEvent) : rawEvent
        if (!throttledEvent) {
            return
        }
