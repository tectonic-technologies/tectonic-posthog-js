...
var MutationRateLimiter = /** @class */ (function () {
    function MutationRateLimiter(rrweb, options) {
        ...
        this.numberOfChanges = function (data) {
            ...
            return (
                ((_b = (_a = data.removes) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0
                    ? _b
                    : 0) +
                ((_d = (_c = data.attributes) === null || _c === void 0 ? void 0 : _c.length) !== null && _d !== void 0
                    ? _d
                    : 0) +
                ((_f = (_e = data.texts) === null || _e === void 0 ? void 0 : _e.length) !== null && _f !== void 0
                    ? _f
                    : 0) +
                ((_h = (_g = data.adds) === null || _g === void 0 ? void 0 : _g.length) !== null && _h !== void 0
                    ? _h
                    : 0)
            )
        }
        this.throttleMutations = function (event) {
            ...
            if (data.attributes) {
                ...
                data.attributes = data.attributes.filter(function (attr) {
                    var _a, _b, _c
                    var _d = __read(_this.getNodeOrRelevantParent(attr.id), 2),
                        nodeId = _d[0],
                        node = _d[1]
                    if (_this.mutationBuckets[nodeId] === 0) {
                        return false
                    }
                    _this.mutationBuckets[nodeId] =
                        (_a = _this.mutationBuckets[nodeId]) !== null && _a !== void 0 ? _a : _this.bucketSize
                    ...
                    if (_this.mutationBuckets[nodeId] === 0) {
                        if (!_this.loggedTracker[nodeId]) {
                            ...
                            ;(_c = (_b = _this.options).onBlockedNode) === null || _c === void 0
                                ? void 0
                                : _c.call(_b, nodeId, node)
                        }
                    }
                    return attr
                })
