...
var ActionMatcher = /** @class */ (function () {
    function ActionMatcher(instance) {
        ...
        this.checkStep = function (event, step) {
            return (
                _this.checkStepEvent(event, step) &&
                _this.checkStepUrl(event, step) &&
                _this.checkStepElement(event, step)
            )
        }
        this.checkStepEvent = function (event, step) {
            // CHECK CONDITIONS, OTHERWISE SKIPPED
            if (
                (step === null || step === void 0 ? void 0 : step.event) &&
                (event === null || event === void 0 ? void 0 : event.event) !==
                    (step === null || step === void 0 ? void 0 : step.event)
            ) {
    ...
    ActionMatcher.prototype.register = function (actions) {
        ...
        actions.forEach(function (action) {
            ...
            ;(_b = action.steps) === null || _b === void 0
                ? void 0
                : _b.forEach(function (step) {
                      var _a
                      ;(_a = _this.actionEvents) === null || _a === void 0
                          ? void 0
                          : _a.add((step === null || step === void 0 ? void 0 : step.event) || '')
                  })
        })
        if ((_b = this.instance) === null || _b === void 0 ? void 0 : _b.autocapture) {
            ...
            actions.forEach(function (action) {
                var _a
                ;(_a = action.steps) === null || _a === void 0
                    ? void 0
                    : _a.forEach(function (step) {
                          if (step === null || step === void 0 ? void 0 : step.selector) {
                              selectorsToWatch_1.add(step === null || step === void 0 ? void 0 : step.selector)
                          }
                      })
            })
            ;(_c = this.instance) === null || _c === void 0
                ? void 0
                : _c.autocapture.setElementSelectors(selectorsToWatch_1)
        }
    }
    ActionMatcher.prototype.on = function (eventName, eventPayload) {
        ...
        if (
            !this.actionEvents.has(eventName) &&
            !this.actionEvents.has(eventPayload === null || eventPayload === void 0 ? void 0 : eventPayload.event)
        ) {
            return
        }
    ...
    ActionMatcher.prototype._addActionHook = function (callback) {
        this.onAction('actionCaptured', function (data) {
    ...
    ActionMatcher.prototype.checkStepUrl = function (event, step) {
        ...
        if (step === null || step === void 0 ? void 0 : step.url) {
            var eventUrl =
                (_a = event === null || event === void 0 ? void 0 : event.properties) === null || _a === void 0
                    ? void 0
                    : _a.$current_url
            ...
            if (
                !ActionMatcher.matchString(
                    eventUrl,
                    step === null || step === void 0 ? void 0 : step.url,
                    (step === null || step === void 0 ? void 0 : step.url_matching) || 'contains'
                )
            ) {
    ...
    ActionMatcher.prototype.checkStepElement = function (event, step) {
        ...
        // CHECK CONDITIONS, OTHERWISE SKIPPED
        if (
            (step === null || step === void 0 ? void 0 : step.href) ||
            (step === null || step === void 0 ? void 0 : step.tag_name) ||
                ...
                !elements.some(function (element) {
                    if (
                        ...
                        !ActionMatcher.matchString(
                            element.href || '',
                            step === null || step === void 0 ? void 0 : step.href,
                            (step === null || step === void 0 ? void 0 : step.href_matching) || 'exact'
                        )
                    ) {
                    ...
                    if (
                        (step === null || step === void 0 ? void 0 : step.tag_name) &&
                        element.tag_name !== (step === null || step === void 0 ? void 0 : step.tag_name)
                    ) {
                    ...
                    if (
                        ...
                        !(
                            ActionMatcher.matchString(
                                element.text || '',
                                step === null || step === void 0 ? void 0 : step.text,
                                (step === null || step === void 0 ? void 0 : step.text_matching) || 'exact'
                            ) ||
                            ActionMatcher.matchString(
                                element.$el_text || '',
                                step === null || step === void 0 ? void 0 : step.text,
