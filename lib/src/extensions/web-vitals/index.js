...
var WebVitalsAutocapture = /** @class */ (function () {
    function WebVitalsAutocapture(instance) {
        ...
        this._flushToCapture = function () {
            ...
            _this.instance.capture(
                '$web_vitals',
                _this.buffer.metrics.reduce(function (acc, metric) {
                    var _a
                    return __assign(
                        __assign({}, acc),
                        ((_a = {}),
                        (_a['$web_vitals_'.concat(metric.name, '_event')] = __assign({}, metric)),
                        (_a['$web_vitals_'.concat(metric.name, '_value')] = metric.value),
                        _a)
                    )
                }, {})
            )
        ...
        this._addToBuffer = function (metric) {
            var _a
            var sessionIds =
                (_a = _this.instance.sessionManager) === null || _a === void 0
                    ? void 0
                    : _a.checkAndGetSessionAndWindowId(true)
            ...
            if (
                isNullish(metric === null || metric === void 0 ? void 0 : metric.name) ||
                isNullish(metric === null || metric === void 0 ? void 0 : metric.value)
            ) {
        ...
        this._startCapturing = function () {
            ...
            if (!isUndefined(posthogExtensions)) {
                ;(_a = posthogExtensions.postHogWebVitalsCallbacks),
                    (onLCP = _a.onLCP),
                    (onCLS = _a.onCLS),
                    (onFCP = _a.onFCP),
                    (onINP = _a.onINP)
        ...
        this._enabledServerSide = !!((_a = this.instance.persistence) === null || _a === void 0
            ? void 0
            : _a.props[WEB_VITALS_ENABLED_SERVER_SIDE])
        this.startIfEnabled()
    }
    Object.defineProperty(WebVitalsAutocapture.prototype, 'allowedMetrics', {
        get: function () {
            ...
            var clientConfigMetricAllowList = isObject(this.instance.config.capture_performance)
                ? (_a = this.instance.config.capture_performance) === null || _a === void 0
                    ? void 0
                    : _a.web_vitals_allowed_metrics
                : undefined
            return !isUndefined(clientConfigMetricAllowList)
                ? clientConfigMetricAllowList
                : ((_b = this.instance.persistence) === null || _b === void 0
                      ? void 0
                      : _b.props[WEB_VITALS_ALLOWED_METRICS]) || ['CLS', 'FCP', 'INP', 'LCP']
        },
        enumerable: false,
        configurable: true,
    })
    ...
    WebVitalsAutocapture.prototype.afterDecideResponse = function (response) {
        ...
        if (this.instance.persistence) {
            this.instance.persistence.register(((_a = {}), (_a[WEB_VITALS_ENABLED_SERVER_SIDE] = webVitalsOptIn), _a))
            this.instance.persistence.register(((_b = {}), (_b[WEB_VITALS_ALLOWED_METRICS] = allowedMetrics), _b))
        }
