...
var Toolbar = /** @class */ (function () {
    ...
    Toolbar.prototype.maybeLoadToolbar = function (location, localStorage, history) {
        ...
        try {
            ...
            var state = stateHash_1
                ? trySafe(function () {
                      return JSON.parse(atob(decodeURIComponent(stateHash_1)))
                  }) ||
                  trySafe(function () {
                      return JSON.parse(decodeURIComponent(stateHash_1))
                  })
                : null
    ...
    Toolbar.prototype.loadToolbar = function (params) {
        ...
        var toolbarParams = __assign(
            __assign(__assign({ token: this.instance.config.token }, params), {
        ...
        window.localStorage.setItem(
            LOCALSTORAGE_KEY,
            JSON.stringify(__assign(__assign({}, toolbarParams), { source: undefined }))
        )
        if (this.getToolbarState() === ToolbarState.LOADED) {
            ...
            this.instance.requestRouter.loadScript(
                '/static/toolbar.js?t='.concat(timestampToNearestFiveMinutes),
                function (err) {
                    if (err) {
