...
export function createEventProcessor(_posthog, _a) {
    var _b = _a === void 0 ? {} : _a,
        organization = _b.organization,
        projectId = _b.projectId,
        prefix = _b.prefix,
        _c = _b.severityAllowList,
        severityAllowList = _c === void 0 ? ['error'] : _c
    return function (event) {
        ...
        var personUrl = _posthog.requestRouter.endpointFor(
            'ui',
            '/project/'.concat(_posthog.config.token, '/person/').concat(_posthog.get_distinct_id())
        )
        ...
        var data = {
            ...
            $sentry_exception_message:
                ((_d = exceptions[0]) === null || _d === void 0 ? void 0 : _d.value) || event.message,
