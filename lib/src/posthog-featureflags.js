...
export var parseFeatureFlagDecideResponse = function (response, persistence, currentFlags, currentFlagPayloads) {
    var _a, _b
    if (currentFlags === void 0) {
        currentFlags = {}
    }
    if (currentFlagPayloads === void 0) {
        currentFlagPayloads = {}
    }
...
var PostHogFeatureFlags = /** @class */ (function () {
    ...
    PostHogFeatureFlags.prototype.getFeatureFlag = function (key, options) {
        ...
        if (options.send_event || !('send_event' in options)) {
            if (!(key in flagCallReported) || !flagCallReported[key].includes(flagReportValue)) {
                ...
                ;(_b = this.instance.persistence) === null || _b === void 0
                    ? void 0
                    : _b.register(((_a = {}), (_a[FLAG_CALL_REPORTED] = flagCallReported), _a))
    ...
    PostHogFeatureFlags.prototype.removeFeatureFlagsHandler = function (handler) {
        this.featureFlagEventHandlers = this.featureFlagEventHandlers.filter(function (h) {
            return h !== handler
        })
    }
    ...
    PostHogFeatureFlags.prototype.onFeatureFlags = function (callback) {
        ...
        if (this.instance.decideEndpointWasHit) {
            var _a = this._prepareFeatureFlagsForCallbacks(),
                flags = _a.flags,
                flagVariants = _a.flagVariants
            callback(flags, flagVariants)
        }
        return function () {
            return _this.removeFeatureFlagsHandler(callback)
        }
    }
    PostHogFeatureFlags.prototype.updateEarlyAccessFeatureEnrollment = function (key, isEnrolled) {
        var _a, _b, _c
        var _d
        var enrollmentPersonProp = ((_a = {}), (_a['$feature_enrollment/'.concat(key)] = isEnrolled), _a)
        ...
        if (!existing_early_access_features || force_reload) {
            this.instance._send_request({
                ...
                callback: function (response) {
                    ...
                    ;(_b = _this.instance.persistence) === null || _b === void 0
                        ? void 0
                        : _b.register(((_a = {}), (_a[PERSISTENCE_EARLY_ACCESS_FEATURES] = earlyAccessFeatures), _a))
    ...
    PostHogFeatureFlags.prototype._fireFeatureFlagsCallbacks = function (errorsLoading) {
        ...
        this.featureFlagEventHandlers.forEach(function (handler) {
            return handler(flags, flagVariants, { errorsLoading: errorsLoading })
        })
    }
    /**
    ...
    PostHogFeatureFlags.prototype.setPersonPropertiesForFlags = function (properties, reloadFeatureFlags) {
        ...
        this.instance.register(
            ((_a = {}), (_a[STORED_PERSON_PROPERTIES_KEY] = __assign(__assign({}, existingProperties), properties)), _a)
        )
    ...
    PostHogFeatureFlags.prototype.setGroupPropertiesForFlags = function (properties, reloadFeatureFlags) {
        ...
        if (Object.keys(existingProperties).length !== 0) {
            Object.keys(existingProperties).forEach(function (groupType) {
                existingProperties[groupType] = __assign(
                    __assign({}, existingProperties[groupType]),
        ...
        this.instance.register(
            ((_a = {}), (_a[STORED_GROUP_PROPERTIES_KEY] = __assign(__assign({}, existingProperties), properties)), _a)
        )
        if (reloadFeatureFlags) {
            this.instance.reloadFeatureFlags()
        }
    ...
    PostHogFeatureFlags.prototype.resetGroupPropertiesForFlags = function (group_type) {
        ...
        if (group_type) {
            ...
            this.instance.register(
                ((_a = {}),
                (_a[STORED_GROUP_PROPERTIES_KEY] = __assign(
                    __assign({}, existingProperties),
                    ((_b = {}), (_b[group_type] = {}), _b)
                )),
                _a)
            )
