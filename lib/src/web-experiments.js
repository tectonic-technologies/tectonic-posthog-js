...
export var webExperimentUrlValidationMap = {
    ...
    regex: function (conditionsUrl, location) {
        return !!window && isUrlMatchingRegex(location.href, conditionsUrl)
    },
    not_regex: function (conditionsUrl, location) {
        return !!window && !isUrlMatchingRegex(location.href, conditionsUrl)
    },
    exact: function (conditionsUrl, location) {
        return location.href === conditionsUrl
    },
    is_not: function (conditionsUrl, location) {
        return location.href !== conditionsUrl
    },
}
var WebExperiments = /** @class */ (function () {
                ...
                webExperiments.forEach(function (webExperiment) {
                    ...
                    if (
                        ...
                        if (_this._flagToExperiments) {
                            ...
                            ;(_a = _this._flagToExperiments) === null || _a === void 0
                                ? void 0
                                : _a.set(webExperiment.feature_flag_key, webExperiment)
                        }
    ...
    WebExperiments.prototype.applyFeatureFlagChanges = function (flags) {
        ...
        flags.forEach(function (flag) {
            var _a, _b
            if (
                _this._flagToExperiments &&
                ((_a = _this._flagToExperiments) === null || _a === void 0 ? void 0 : _a.has(flag))
            ) {
                ...
                if (
                    selectedVariant &&
                    (webExperiment === null || webExperiment === void 0
                        ? void 0
                        : webExperiment.variants[selectedVariant])
                ) {
                    WebExperiments.applyTransforms(
                        webExperiment.name,
                        selectedVariant,
    ...
    WebExperiments.matchUrlConditions = function (testVariant) {
        var _a, _b, _c, _d
        if (
            isNullish(testVariant.conditions) ||
            isNullish((_a = testVariant.conditions) === null || _a === void 0 ? void 0 : _a.url)
        ) {
            return true
        }
        ...
        if (location) {
            var urlCheck = ((_b = testVariant.conditions) === null || _b === void 0 ? void 0 : _b.url)
                ? webExperimentUrlValidationMap[
                      (_d = (_c = testVariant.conditions) === null || _c === void 0 ? void 0 : _c.urlMatchType) !==
                          null && _d !== void 0
                          ? _d
                          : 'icontains'
                  ](testVariant.conditions.url, location)
                : true
            return urlCheck
        }
        return false
    ...
    WebExperiments.matchUTMConditions = function (testVariant) {
        ...
        if (
            isNullish(testVariant.conditions) ||
            isNullish((_a = testVariant.conditions) === null || _a === void 0 ? void 0 : _a.utm)
        ) {
            return true
        }
        ...
        if (campaignParams['utm_source']) {
            ...
            var utmCampaignMatched = (
                (_c = (_b = testVariant.conditions) === null || _b === void 0 ? void 0 : _b.utm) === null ||
                _c === void 0
                    ? void 0
                    : _c.utm_campaign
            )
                ? ((_e = (_d = testVariant.conditions) === null || _d === void 0 ? void 0 : _d.utm) === null ||
                  _e === void 0
                      ? void 0
                      : _e.utm_campaign) == campaignParams['utm_campaign']
                : true
            var utmSourceMatched = (
                (_g = (_f = testVariant.conditions) === null || _f === void 0 ? void 0 : _f.utm) === null ||
                _g === void 0
                    ? void 0
                    : _g.utm_source
            )
                ? ((_j = (_h = testVariant.conditions) === null || _h === void 0 ? void 0 : _h.utm) === null ||
                  _j === void 0
                      ? void 0
                      : _j.utm_source) == campaignParams['utm_source']
                : true
            var utmMediumMatched = (
                (_l = (_k = testVariant.conditions) === null || _k === void 0 ? void 0 : _k.utm) === null ||
                _l === void 0
                    ? void 0
                    : _l.utm_medium
            )
                ? ((_o = (_m = testVariant.conditions) === null || _m === void 0 ? void 0 : _m.utm) === null ||
                  _o === void 0
                      ? void 0
                      : _o.utm_medium) == campaignParams['utm_medium']
                : true
            var utmTermMatched = (
                (_q = (_p = testVariant.conditions) === null || _p === void 0 ? void 0 : _p.utm) === null ||
                _q === void 0
                    ? void 0
                    : _q.utm_term
            )
                ? ((_s = (_r = testVariant.conditions) === null || _r === void 0 ? void 0 : _r.utm) === null ||
                  _s === void 0
                      ? void 0
                      : _s.utm_term) == campaignParams['utm_term']
                : true
    ...
    WebExperiments.applyTransforms = function (experiment, variant, transforms) {
        transforms.forEach(function (transform) {
            if (transform.selector) {
                WebExperiments.logInfo(
                    'applying transform of variant '.concat(variant, ' for experiment ').concat(experiment, ' '),
                    transform
                )
                // eslint-disable-next-line no-restricted-globals
                var elements =
                    document === null || document === void 0 ? void 0 : document.querySelectorAll(transform.selector)
