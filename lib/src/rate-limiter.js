...
var RateLimiter = /** @class */ (function () {
    function RateLimiter(instance) {
        ...
        this.captureEventsPerSecond =
            ((_a = instance.config.rate_limiting) === null || _a === void 0 ? void 0 : _a.events_per_second) || 10
        this.captureEventsBurstLimit = Math.max(
            ((_b = instance.config.rate_limiting) === null || _b === void 0 ? void 0 : _b.events_burst_limit) ||
                this.captureEventsPerSecond * 10,
            this.captureEventsPerSecond
        )
    ...
    RateLimiter.prototype.clientRateLimitContext = function (checkOnly) {
        ...
        var bucket =
            (_b =
                (_a = this.instance.persistence) === null || _a === void 0
                    ? void 0
                    : _a.get_property(CAPTURE_RATE_LIMIT)) !== null && _b !== void 0
                ? _b
                : {
        ...
        ;(_c = this.instance.persistence) === null || _c === void 0
            ? void 0
            : _c.set_property(CAPTURE_RATE_LIMIT, bucket)
        return {
