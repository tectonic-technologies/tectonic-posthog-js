...
var PageViewManager = /** @class */ (function () {
    ...
    PageViewManager.prototype.doPageView = function (timestamp) {
        ...
        this._currentPath =
            (_a = window === null || window === void 0 ? void 0 : window.location.pathname) !== null && _a !== void 0
                ? _a
                : ''
    ...
    PageViewManager.prototype._previousPageViewProperties = function (timestamp) {
        ...
        var properties = {}
        if (scrollContext) {
            var maxScrollHeight = scrollContext.maxScrollHeight,
                lastScrollY = scrollContext.lastScrollY,
                maxScrollY = scrollContext.maxScrollY,
                maxContentHeight = scrollContext.maxContentHeight,
                lastContentY = scrollContext.lastContentY,
                maxContentY = scrollContext.maxContentY
            if (
