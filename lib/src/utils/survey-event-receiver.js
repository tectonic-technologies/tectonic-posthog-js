...
var SurveyEventReceiver = /** @class */ (function () {
    ...
    SurveyEventReceiver.prototype.setupActionBasedSurveys = function (surveys) {
        var _this = this
        var actionBasedSurveys = surveys.filter(function (survey) {
            var _a, _b, _c, _d
            return (
                ((_a = survey.conditions) === null || _a === void 0 ? void 0 : _a.actions) &&
                ((_d =
                    (_c = (_b = survey.conditions) === null || _b === void 0 ? void 0 : _b.actions) === null ||
                    _c === void 0
                        ? void 0
        ...
        actionBasedSurveys.forEach(function (survey) {
            ...
            if (
                ...
                _c === void 0
                    ...
                    : _c.values) &&
                ((_f =
                    (_e = (_d = survey.conditions) === null || _d === void 0 ? void 0 : _d.actions) === null ||
                    _e === void 0
                        ? void 0
                ...
                // events to actions
                ;(_g = _this.actionMatcher) === null || _g === void 0
                    ? void 0
                    : _g.register(survey.conditions.actions.values)
                // maintain a mapping of (Action1) => [Survey1, Survey2, Survey3]
                // where Surveys 1-3 are all activated by Action1
                ;(_k =
                    (_j = (_h = survey.conditions) === null || _h === void 0 ? void 0 : _h.actions) === null ||
                    _j === void 0
                        ? void 0
                        : _j.values) === null || _k === void 0
                    ? void 0
                    : _k.forEach(function (action) {
    ...
    SurveyEventReceiver.prototype.onEvent = function (event, eventPayload) {
        var _a, _b, _c
        var existingActivatedSurveys =
            ((_b = (_a = this.instance) === null || _a === void 0 ? void 0 : _a.persistence) === null || _b === void 0
                ? void 0
                : _b.props[SURVEYS_ACTIVATED]) || []
        if (
            ...
            var surveyId =
                (_c = eventPayload === null || eventPayload === void 0 ? void 0 : eventPayload.properties) === null ||
                _c === void 0
                    ? void 0
                    : _c.$survey_id
            if (surveyId) {
    ...
    SurveyEventReceiver.prototype._updateActivatedSurveys = function (activatedSurveys) {
        ...
        ;(_c = (_b = this.instance) === null || _b === void 0 ? void 0 : _b.persistence) === null || _c === void 0
            ? void 0
            : _c.register(
                  ((_a = {}), (_a[SURVEYS_ACTIVATED] = __spreadArray([], __read(new Set(activatedSurveys)), false)), _a)
              )
    }
